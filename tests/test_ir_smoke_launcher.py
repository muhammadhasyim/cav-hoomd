"""Tests for equilibrium IR smoke launcher queue generation."""
...
LAUNCHER = REPO_ROOT / "aging_weak_lambda_ir" / "run_local_ir_smoke.sh"


def test_ir_smoke_dry_run_queue_size(tmp_path: Path) -> None:
    ...
    queue = base / "logs" / "ir_smoke" / "ir_queue.tsv"
