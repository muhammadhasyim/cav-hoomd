"""
Harmonic Bond Reset for Diatomic Molecules

This module provides a class to thermally reinitialize the internal stretch DOF
of diatomic molecules without disturbing COM motion or orientation.

Option B: Exact thermal sampling of bond stretch (canonical ensemble)

Author: Generated for cavity-MD analysis
Date: 2025-10-08
"""
